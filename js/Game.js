class Game {
  constructor(start) {
    ...
    this.red.forEach(
      (item) => (item.style.backgroundImage = 'url("img/cherry.PNG")')
    );
    this.green.forEach(
      (item) => (item.style.backgroundImage = 'url("img/lemon.PNG")')
    );
    this.blue.forEach(
      (item) => (item.style.backgroundImage = 'url("img/waterlemon.PNG")')
    );
